...
// FIXME: `print(Enum.KeyCode.A.Enum, Enum.KeyCode)` crashes; I assume we shouldn't be calling pushlightuserdata with that addres...
...
static int Enum__index(lua_State* L) {
    Console::ScriptConsole.debug(getStackMessage(L));
